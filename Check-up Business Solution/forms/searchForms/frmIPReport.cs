...
namespace Check_up.forms
{
    public partial class frmInventoryPostingReport : Form
    {
        ...
        private void chkInventoryPosting_CheckedChanged(object sender, EventArgs e)
        {
            if (chkDR.Checked == true)
            {
        ...
        private void txtIPNoFrm_TextChanged(object sender, EventArgs e)
        {
            if (txtDRNoFrm.Text.Trim() == "")
                linkLabelDeliveryReceipt.Enabled = true;
        }

        private void txtIPNoTo_TextChanged(object sender, EventArgs e)
        {
